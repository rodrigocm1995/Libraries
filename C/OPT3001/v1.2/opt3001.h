...
#define OPT3001_CR_FC_Pos           (0U)
#define OPT3001_CR_FC_Mask          (0x3U << OPT3001_CR_FC_Pos)
#define OPT3001_CR_FC               OPT3001_CR_FC_Mask
#define OPT3001_CR_0                (0x1U << OPT3001_CR_FC_Pos)
#define OPT3001_CR_1                (0x2U << OPT3001_CR_FC_Pos)

#define OPT3001_CR_Pos              (2U)
#define OPT3001_CR_ME_Mask          (0x1U << OPT3001_CR_Pos)
#define OPT3001_CR_ME               OPT3001_CR_ME_Mask

#define OPT3001_CR_POL_Pos          (3U)
#define OPT3001_CR_POL_Mask         (0x1U << OPT3001_CR_POL_Pos)
#define OPT3001_CR_POL              OPT3001_CR_POL_Mask

#define OPT3001_CR_L_Pos            (4U)
#define OPT3001_CR_L_Mask           (0x1U << OPT3001_CR_L_Pos)
#define OPT3001_CR_L                OPT3001_CR_L_Mask

#define OPT3001_CR_FL_Pos           (5U)
#define OPT3001_CR_FL_Mask          (0x1U << OPT3001_CR_FL_Pos)
#define OPT3001_CR_FL               OPT3001_CR_FL_Mask

#define OPT3001_CR_FH_Pos           (6U)
#define OPT3001_CR_FH_Mask          (0x1U << OPT3001_CR_FH_Pos)
#define OPT3001_CR_FH               OPT3001_CR_FH_Mask

#define OPT3001_CR_CRF_Pos          (7U)
#define OPT3001_CR_CRF_Mask         (0x1U << OPT3001_CR_CRF_Pos)
#define OPT3001_CR_CRF              OPT3001_CR_CRF_Mask

#define OPT3001_CR_OVF_Pos          (8U)
#define OPT3001_CR_OVF_Mask         (0x1U << OPT3001_CR_OVF_Pos)
#define OPT3001_CR_OVF              OPT3001_CR_OVF_Mask

#define OPT3001_CR_M_Pos            (9U)
#define OPT3001_CR_M_Mask           (0x3U << OPT3001_CR_M_Pos)
#define OPT3001_CR_M                 OPT3001_CR_M_Mask
#define OPT3001_CR_M_0              (0x1U << OPT3001_CR_M_Pos)
#define OPT3001_CR_M_1              (0x2U << OPT3001_CR_M_Pos)

#define OPT3001_CR_CT_Pos           (11U)
#define OPT3001_CR_CT_Mask          (0x1U << OPT3001_CR_CT_Pos)
#define OPT3001_CR_CT               OPT3001_CR_CT_Mask

#define OPT3001_CR_RN_Pos           (12U)
#define OPT3001_CR_RN_Mask          (0xFU << OPT3001_CR_RN_Pos)
#define OPT3001_CR_RN               OPT3001_CR_RN_Mask
#define OPT3001_CR_RN_0             (0x1U << OPT3001_CR_RN_Pos)
#define OPT3001_CR_RN_1             (0x2U << OPT3001_CR_RN_Pos)
#define OPT3001_CR_RN_2             (0x4U << OPT3001_CR_RN_Pos)
#define OPT3001_CR_RN_3             (0x8U << OPT3001_CR_RN_Pos)

#define FSR_40_95					(OPT3001_CR_RN_0)

typedef enum
{
	OPT3001_40_95_LUX					= 0x0U,
	OPT3001_81_90_LUX					= OPT3001_CR_RN_0,
	OPT3001_163_80_LUX					= OPT3001_CR_RN_1,
	OPT3001_327_60_LUX					= (OPT3001_CR_RN_0 | OPT3001_CR_RN_1),
	OPT3001_655_20_LUX					= OPT3001_CR_RN_2,
	OPT3001_1310_40_LUX					= OPT3001_CR_RN_0 | OPT3001_CR_RN_2,
	OPT3001_2620_80_LUX					= OPT3001_CR_RN_1 | OPT3001_CR_RN_2,
	OPT3001_5241_60_LUX					= OPT3001_CR_RN_0 | OPT3001_CR_RN_1 | OPT3001_CR_RN_2,
	OPT3001_10483_20_LUX				= OPT3001_CR_RN_3,
	OPT3001_20966_40_LUX				= OPT3001_CR_RN_0 | OPT3001_CR_RN_3,
	OPT3001_41932_80_LUX				= OPT3001_CR_RN_1 | OPT3001_CR_RN_3,
	OPT3001_83865_60_LUX				= (OPT3001_CR_RN_0 | OPT3001_CR_RN_1 | OPT3001_CR_RN_3),
	OPT3001_AUTOMATIC_RANGE				= OPT3001_CR_RN_2 | OPT3001_CR_RN_3,
...
typedef enum
{
	OPT3001_SHUTDOWN					= 0x0U,
	OPT3001_SINGLE_SHOT					= OPT3001_CR_M_0,
	OPT3001_CONTINUOUS_CONVERSION		= OPT3001_CR_M_1,
...
void OPT3001_SetCT_100_MS(OPT3001_HandleTypeDef *opt3001);
