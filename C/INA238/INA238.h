...
typedef struct 
{
  ...
  double             shuntAdcResolution;
} Ina238_t;


void ina238WriteRegister(Ina238_t *ina238, uint8_t registerAddress, int16_t value);
uint16_t ina238ReadRegister(Ina238_t *ina238, uint8_t registerAddress);

void ina238Init(Ina238_t *ina238, I2C_HandleTypeDef *i2c, uint8_t devAddress);
void ina238CustomInit(Ina238_t *ina238, I2C_HandleTypeDef *i2c, uint8_t devAddress, Ina238ConvDly convDly, Ina238AdcRange adcRange);

void ina238AdcConfig(Ina238_t *ina238);
void ina238CustomAdcConfig(Ina238_t *ina238, Ina238Mode mode, Ina238VbusConvTime vbusCt, Ina238VshuntConvTime vShuntCt, Ina238TempConvTime tempCt, Ina238Avg avg);

uint16_t ina238SetCalibration(Ina238_t *ina238, double rShuntValue, double maxCurrent);

uint8_t  ina238SetShuntUnderVoltage(Ina238_t *ina238);
uint8_t  ina238SetShuntOverVoltage(Ina238_t *ina238);
int16_t  ina238SetShuntUnderVoltage(Ina238_t *ina238, float shuntUnderVoltage);
int16_t  ina238SetShuntOverVoltage(Ina238_t *ina238, float shuntOverVoltage);

uint8_t  ina238SetBusUnderVoltage(Ina238_t *ina238);
uint8_t  ina238SetBusOverVoltage(Ina238_t *ina238);
uint16_t ina238SetBusUnderVoltage(Ina238_t *ina238, float busUnderVoltage);
uint16_t ina238SetBusOverVoltage(Ina238_t *ina238, float busOverVoltage);

uint8_t  ina238SetTemperatureLimit(Ina238_t *ina238);
int16_t  ina238SetTemperatureLimit(Ina238_t *ina238, float temperatureLimit);

uint16_t ina238SetPowerLimit(Ina238_t *ina238);
uint16_t ina238SetPowerLimit(Ina238_t *ina238, float power);

int16_t  ina238GetShuntUnderVoltage(Ina238_t *ina238);
int16_t  ina238GetShuntOverVoltage(Ina238_t *ina238);

uint16_t ina238GetBusUnderVoltage(Ina238_t *ina238);
uint16_t ina238GetBusOverVoltage(Ina238_t *ina238);

int16_t  ina238GetTemperatureLimit(Ina238_t *ina238); 

double    getShuntVoltage(Ina238_t *ina238);
double    getBusVoltage(Ina238_t *ina238);
double    getCurrent(Ina238_t *ina238);  
double    getPower(Ina238_t *ina238);
double    getTemperature(Ina238_t *ina238);
